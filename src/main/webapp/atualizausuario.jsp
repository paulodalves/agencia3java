	...
	<div class="container">
		<div class="row">
			<div class="cold-md-7">
				...
				<h1 id="titulo-padding" class="display-4">Atualizar de Usuário</h1>
				<main>
					<form action="UAtualizar" method="post" class="row g-3">
						<input class="esconder-id" type="text"
							value="${usuario.idUsuario}" name="id" />
						<div class="col-md-6">
							<label class="form-label">Nome:</label> <input
								value="${usuario.nome}" maxlength="15" type="text"
								class="form-control" name="nome" placeholder="Nome">
						</div>
						<div class="col-md-6">
							<label class="form-label">Sobrenome:</label> <input
								value="${usuario.sobrenome}" maxlength="15" type="text"
								class="form-control" name="sobrenome" placeholder="Sobrenome">
						</div>

						<div class="col-md-4">
							<label class="form-label">CPF:</label> <input maxlength="14"
								name="cpf" value="${usuario.cpf}" type="text" class="form-control">
						</div>
						<div class="col-md-4">
							<label for="inputState" class="form-label">Gênero</label> <select
								name="sexo" class="form-select">
								<option value="Outros" selected>-- Escolha --</option>
						...
						<div class="col-4">
							<label class="form-label">Data de Nascimento</label> <input
								value="${usuario.dataNascimento}" type="date"
								class="form-control" name="dtNascimento">
						</div>
						<div class="col-md-4">
							<label class="form-label">Telefone:</label> <input type="text"
							value="${usuario.telefone}"	maxlength="11" name="telefone" class="form-control">
						</div>

						<div class="col-md-4">
							<label class="form-label">E-mail:</label> <input
								value="${usuario.email}" type="email"
								class="form-control" name="email">
						</div>
						<div class="col-md-4">
							<label for="inputCity" class="form-label">Senha:</label> <input
								value="${usuario.senha}" type="password" class="form-control"
								maxlength="8" name="senha">
						</div>
