	...
	<div class="container">
		<div class="row">
			<div class="cold-md-7">
				...
				<h1 id="titulo-padding" class="display-4">Selecionar usuário e destino</h1>
				<main>
					<form action="VCriarEPesquisar" method="post" class="row g-3">


						<div class="col-md-4">

							<label for="inputState" class="form-label">Usuário:</label> <select
								name="idUsuario" class="form-select">
						...
						<div class="col-md-4">
							<label for="inputState" class="form-label">Destino:</label> <select
								name="idDestino" class="form-select">
								<option selected>-- Selecionar --</option>
								<c:forEach items="${destinos}" var="destino">
									<option value="${destino.idDestino }">${destino.descricao }
										- ${destino.valor}</option>
								</c:forEach>
							</select>
						</div>
						<div class="col-md-4">
							<label class="form-label">Data de Partida</label> <input
								type="date" class="form-control" name="dataPartida">
						</div>
						<div class="col-md-6">
							<label class="form-label">Data de Retorno</label> <input
								type="date" class="form-control" name="dataRetorno">
						</div>
						<div class="col-md-6">
							<label class="form-label">Tipo de Transporte:</label> <select
								name="transporte" class="form-control">
								<option selected>-- Selecione --</option>
								<option value="Aviao">Avião</option>
								<option value="Onibus">Ônibus</option>
							</select>
						</div>
						<input class="btn-cadastro" type="submit" value="Marcar" />
					</form>
				</main>
			</div>
		</div>
