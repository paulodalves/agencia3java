		...
		<div class="row">
			<div class="cold-md-7">
				<main>
					...
					<h1 id="titulo-padding" style="text-align: center"
						class="display-4">Destino Certo</h1>
						...
						<div class="carousel-inner">
							<div class="carousel-item active">
								...
								<div class="carousel-caption d-none d-md-block">
									...
									<p>Picos montanhosos cobertos de neve.</p>
								</div>
							</div>
							<div class="carousel-item">
								<img src="./imagens/2.jpg" class="d-block w-100" height="400px"
									...
									<p>Praias paradisíacas que te deixam sem fôlego!</p>
								</div>
							</div>
							<div class="carousel-item">
								<img src="./imagens/3.jpg" class="d-block w-100" height="400px"
									...
									<p>Cidades que que lhe proporcionaram experiências únicas!</p>
								</div>
							</div>
						</div>
