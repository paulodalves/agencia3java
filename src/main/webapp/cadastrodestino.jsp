...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="cold-md-7">
				<h1 id="titulo-padding" class="display-4">Cadastro de Destino</h1>

				<main>
					<form action="DCriarEPesquisar" method="post" class="row g-3">
						...
						<div class="col-md-6">
							<label class="form-label">Valor:</label> <input type="number"
								class="form-control" name="valor" placeholder="">
						</div>
