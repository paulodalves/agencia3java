	...
	<div class="container">
		<div class="row">
			<div class="cold-md-7">
				...
				<h1 id="titulo-padding" class="display-4">Cadastro de Usuário</h1>

				<form action="UCriarEPesquisar" method="post" class="row g-3">
					...
					<div class="col-4">
						<label class="form-label">Data de Nascimento</label> <input
							type="date" class="form-control" name="dtNascimento">
					</div>
					<div class="col-md-4">
